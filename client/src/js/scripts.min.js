...
$templateCache.put("/static/templates/partials/author.html","<a class=\'author\' ui-sref=\'author.publications({username:author.username})\'>{{author.first_name}} {{author.last_name}}</a>{{$single || $last? \'\':\', \'}}");
...
$templateCache.put("/static/templates/partials/placeholder.html","<div ng-if=\'type==\"doc\"\' ng-include=\'\"templates/partials/document.placeholder.html\"|prefixTemplate\'></div>\n<span ng-if=\'type==\"voc\"\' ng-include=\'\"templates/partials/term.placeholder.html\"|prefixTemplate\'></span>");
...
$templateCache.put("/static/templates/partials/tag.html","<span ng-if=\'tag.category != \"keyword\"\' class=\'tag\' ng-class=\'tag.category\'>{{tag.name}}</span><span ng-if=\'tag.category == \"keyword\"\' class=\'tag\' ng-class=\'tag.category\'><a a href ui-sref=\'publications.tags({slug: tag.slug})\'>{{tag.name}}</a></span>{{$last?\' \': \', \'}}");
