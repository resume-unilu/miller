...
$templateCache.put("/static/templates/partials/author.html","<a class=\'author\' href=\'users/\'>{{author.first_name}} {{author.last_name}}</a>{{$last?\'\':\', \'}}");
