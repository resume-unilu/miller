...
$templateCache.put("/static/templates/items.html","<div ng-if=\'items.length === 0\' translate=\'items.empty\'></div>\n<div ng-repeat=\'story in items\' ng-include=\'\"templates/partials/story.html\"|prefixTemplate\'></div>");
