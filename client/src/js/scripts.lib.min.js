...
return t&&t.length?(e=r||e===ie?1:Jt(e),K(t,0,0>e?0:e)):[]},g.tap=function(t,e){return e(t),t},g.thru=Et,g.toArray=qt,g.toPairs=Mr,g.uniq=function(t){if(t&&t.length)t:{var e=-1,r=i,n=t.length,o=true,u=[],a=u;if(n>=200){if(r=jr(t)){t=v(r);break t}o=false,r=h,a=new x}else a=u;e:for(;++e<n;){var c=t[e],f=c,c=0!==c?c:0;if(o&&f===f){for(var _=a.length;_--;)if(a[_]===f)continue e;u.push(c)}else r(a,f,void 0)||(a!==u&&a.push(f),u.push(c))}t=u}else t=[];return t},g.values=Zt,g.entries=Mr,ne(g,g),g.eq=It,g.forEach=Rt,
g.get=Qt,g.hasIn=Xt,g.head=kt,g.identity=ee,g.isArguments=Ut,g.isArray=Sr,g.isArrayLike=Bt,g.isArrayLikeObject=Ct,g.isBuffer=Er,g.isEmpty=function(t){if(Bt(t)&&(Sr(t)||Vt(t)||Dt(t.splice)||Ut(t)||Er(t)))return!t.length;if(zt(t)){var e=lt(t);if("[object Map]"==e||"[object Set]"==e)return!t.size}for(var r in t)if(De.call(t,r))return false;return!(ar&&Yt(t).length)},g.isFunction=Dt,g.isLength=Lt,g.isNative=Pt,g.isObject=Nt,g.isObjectLike=zt,g.isString=Vt,g.isSymbol=Wt,g.isTypedArray=Tt,g.last=Ot,g.noop=oe,
g.now=xr,g.toFinite=Gt,g.toInteger=Jt,g.toNumber=Ht,g.toString=Kt,g.each=Rt,g.first=kt,ne(g,function(){var t={};return C(g,function(e,r){De.call(g.prototype,r)||(t[r]=e)}),t}(),{chain:false}),g.VERSION="4.12.0",o(["drop","take"],function(t,e){A.prototype[t]=function(r){var n=this.__filtered__;if(n&&!e)return new A(this);r=r===ie?1:Xe(Jt(r),0);var o=this.clone();return n?o.__takeCount__=Ye(r,o.__takeCount__):o.__views__.push({size:Ye(r,4294967295),type:t+(0>o.__dir__?"Right":"")}),o},A.prototype[t+"Right"]=function(e){
return this.reverse()[t](e).reverse()}}),o(["filter","map","takeWhile"],function(t,e){var r=e+1,n=1==r||3==r;A.prototype[t]=function(t){var e=this.clone();return e.__iteratees__.push({iteratee:at(t,3),type:r}),e.__filtered__=e.__filtered__||n,e}}),o(["head","last"],function(t,e){var r="take"+(e?"Right":"");A.prototype[t]=function(){return this[r](1).value()[0]}}),o(["initial","tail"],function(t,e){var r="drop"+(e?"":"Right");A.prototype[t]=function(){return this.__filtered__?new A(this):this[r](1);
}}),A.prototype.compact=function(){return this.filter(ee)},A.prototype.find=function(t){return this.filter(t).head()},A.prototype.findLast=function(t){return this.reverse().find(t)},A.prototype.invokeMap=Ft(function(t,e){return typeof t=="function"?new A(this):this.map(function(n){var o=t;return dt(o,n)||(o=X(o),n=1==o.length?n:L(n,K(o,0,-1)),o=Ot(o)),o=null==n?n:n[wt(o)],null==o?ie:r(o,n,e)})}),A.prototype.reject=function(t){return t=at(t,3),this.filter(function(e){return!t(e)})},A.prototype.slice=function(t,e){
t=Jt(t);var r=this;return r.__filtered__&&(t>0||0>e)?new A(r):(0>t?r=r.takeRight(-t):t&&(r=r.drop(t)),e!==ie&&(e=Jt(e),r=0>e?r.dropRight(-e):r.take(e-t)),r)},A.prototype.takeRightWhile=function(t){return this.reverse().takeWhile(t).reverse()},A.prototype.toArray=function(){return this.take(4294967295)},C(A.prototype,function(t,e){var r=/^(?:filter|find|map|reject)|While$/.test(e),n=/^(?:head|last)$/.test(e),o=g[n?"take"+("last"==e?"Right":""):e],u=n||/^find/.test(e);o&&(g.prototype[e]=function(){
function e(t){return t=o.apply(g,c([t],a)),n&&l?t[0]:t}var i=this.__wrapped__,a=n?[1]:arguments,f=i instanceof A,_=a[0],s=f||Sr(i);s&&r&&typeof _=="function"&&1!=_.length&&(f=s=false);var l=this.__chain__,h=!!this.__actions__.length,_=u&&!l,f=f&&!h;return!u&&s?(i=f?i:new A(this),i=t.apply(i,a),i.__actions__.push({func:Et,args:[e],thisArg:ie}),new w(i,l)):_&&f?t.apply(this,a):(i=this.thru(e),_?n?i.value()[0]:i.value():i)})}),o("pop push shift sort splice unshift".split(" "),function(t){var e=Ue[t],r=/^(?:push|sort|unshift)$/.test(t)?"tap":"thru",n=/^(?:pop|shift)$/.test(t);
g.prototype[t]=function(){var t=arguments;if(n&&!this.__chain__){var o=this.value();return e.apply(Sr(o)?o:[],t)}return this[r](function(r){return e.apply(Sr(r)?r:[],t)})}}),C(A.prototype,function(t,e){var r=g[e];if(r){var n=r.name+"";(cr[n]||(cr[n]=[])).push({name:e,func:r})}}),cr[ot(ie,2).name]=[{name:"wrapper",func:ie}],A.prototype.clone=function(){var t=new A(this.__wrapped__);return t.__actions__=tt(this.__actions__),t.__dir__=this.__dir__,t.__filtered__=this.__filtered__,t.__iteratees__=tt(this.__iteratees__),
t.__takeCount__=this.__takeCount__,t.__views__=tt(this.__views__),t},A.prototype.reverse=function(){if(this.__filtered__){var t=new A(this);t.__dir__=-1,t.__filtered__=true}else t=this.clone(),t.__dir__*=-1;return t},A.prototype.value=function(){var t,e=this.__wrapped__.value(),r=this.__dir__,n=Sr(e),o=0>r,u=n?e.length:0;t=u;for(var i=this.__views__,a=0,c=-1,f=i.length;++c<f;){var _=i[c],s=_.size;switch(_.type){case"drop":a+=s;break;case"dropRight":t-=s;break;case"take":t=Ye(t,a+s);break;case"takeRight":
a=Xe(a,t-s)}}if(t={start:a,end:t},i=t.start,a=t.end,t=a-i,o=o?a:i-1,i=this.__iteratees__,a=i.length,c=0,f=Ye(t,this.__takeCount__),!n||200>u||u==t&&f==t)return Q(e,this.__actions__);n=[];t:for(;t--&&f>c;){for(o+=r,u=-1,_=e[o];++u<a;){var l=i[u],s=l.type,l=(0,l.iteratee)(_);if(2==s)_=l;else if(!l){if(1==s)continue t;break t}}n[c++]=_}return n},g.prototype.chain=function(){return St(this)},g.prototype.commit=function(){return new w(this.value(),this.__chain__)},g.prototype.next=function(){this.__values__===ie&&(this.__values__=qt(this.value()));
var t=this.__index__>=this.__values__.length,e=t?ie:this.__values__[this.__index__++];return{done:t,value:e}},g.prototype.plant=function(t){for(var e,r=this;r instanceof j;){var n=mt(r);n.__index__=0,n.__values__=ie,e?o.__wrapped__=n:e=n;var o=n,r=r.__wrapped__}return o.__wrapped__=t,e},g.prototype.reverse=function(){var t=this.__wrapped__;return t instanceof A?(this.__actions__.length&&(t=new A(this)),t=t.reverse(),t.__actions__.push({func:Et,args:[xt],thisArg:ie}),new w(t,this.__chain__)):this.thru(xt);
},g.prototype.toJSON=g.prototype.valueOf=g.prototype.value=function(){return Q(this.__wrapped__,this.__actions__)},Te&&(g.prototype[Te]=Mt),($e||Re||{})._=g,typeof define=="function"&&typeof define.amd=="object"&&define.amd? define(function(){return g}):Se&&Ee?(Me&&((Ee.exports=g)._=g),Se._=g):Ie._=g}).call(this);
/**
